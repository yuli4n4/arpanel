  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<?= base_url('auth/users_list') ?>"><i class="fa fa-user"></i> <span>Users </span><span class="pull-right-container"><small class="label pull-right bg-yellow"><?= count($users) ?></small></span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('auth/show_profile') ?>">Profile</a></li>
