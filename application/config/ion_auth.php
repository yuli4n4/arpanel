 ...
 */
$config['site_title']                 = $_SERVER['HTTP_HOST'];       // Site Title, example.com
$config['admin_email']                = 'admin@'.$_SERVER['HTTP_HOST']; // Admin Email, admin@example.com
...
/*
 ...
 |
 */
 $config['login_header']	= 'layouts/auth/header';
 $config['login_footer']	= 'layouts/auth/footer';
/*
 | -------------------------------------------------------------------------
 | Cookie options.
 | -------------------------------------------------------------------------
